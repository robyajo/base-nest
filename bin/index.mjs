...
if (flags.help) {
  ...
  console.log(`    ${pc.cyan('npx bns --setup-pg')}     Switch project to PostgreSQL`);
  console.log(`    ${pc.cyan('npx bns --upgrade')}      Upgrade project to latest template`);
  console.log(`    ${pc.cyan('npx bns --jwt-secret')}   Generate JWT secrets`);
  console.log();
